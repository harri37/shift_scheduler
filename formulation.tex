...
\section*{Objective}
Minimize 
$$w_1 \cdot \sum_{p \in P} \sum_{d \in D} Y_{pd} + w_2 \cdot \sum_{s \in S} \sum_{p \in P} \sum_{d \in D} X_{psd} - w_3 \cdot \sum_{s \in S} \sum_{p \in P} \sum_{d \in D} X_{psd} * length_{s}$$ %Ideally you want to include tutors having similar average hours here but i dont know how (this is fine for a small scale problem like this though)
